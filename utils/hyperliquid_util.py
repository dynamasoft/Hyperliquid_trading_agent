...
HL_SECRET_KEY = os.getenv("HL_SECRET_KEY")  # Set this in your environment variables
HL_ACCOUNT_ADDRESS = os.getenv(
    "HL_ACCOUNT_ADDRESS"
...
def setup(base_url=None, skip_ws=False):
    ...
    account: LocalAccount = eth_account.Account.from_key(HL_SECRET_KEY)
    address = HL_ACCOUNT_ADDRESS
    if address == "":
